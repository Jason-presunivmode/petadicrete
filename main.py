...
def profile_page():
    ...
    with col2:
        st.image("https://raw.githubusercontent.com/Jason-presunivmode/petadicrete/refs/heads/main/Guest2.jpg", use_container_width=True)
        st.markdown("<p style='text-align: center; font-size: 16px;'>Risma Choerunnisa</p>", unsafe_allow_html=True)

    with col3:
        st.image("https://raw.githubusercontent.com/Jason-presunivmode/petadicrete/refs/heads/main/Guest1.jpg", use_container_width=True)
